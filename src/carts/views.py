...
def cart_detail_api_view(request):
    ...
    product = [{"name":x.title,"price":x.price} for x in cart_obj.products.all()]
    print(cart_obj.total)
    print(cart_obj.subtotal)
    return JsonResponse({"products": product, "subtotal":cart_obj.subtotal,"total":cart_obj.total })
...
def checkout_done(request):
    return render(request,"checkout_done", {})